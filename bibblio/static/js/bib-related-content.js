...
function bib_recommendationUrl(contentItemId, catalogueIds, limit, page, fields) {
    ...
    return "http://bibblioap-ecselast-881w20a9rr8s-1070858493.eu-west-1.elb.amazonaws.com/content-items/" + contentItemId + "/recommendations?limit=" + limit + "&page=" + page + "&" + querystringFields + (querystringCatalogueIds ? "&" + querystringCatalogueIds : "");
}
